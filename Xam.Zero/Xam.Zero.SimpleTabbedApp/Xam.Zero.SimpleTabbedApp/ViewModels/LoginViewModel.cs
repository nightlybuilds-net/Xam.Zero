...
namespace Xam.Zero.SimpleTabbedApp.ViewModels
{
    public class LoginViewModel: ZeroBaseModel
    {
        ...
        public LoginViewModel(IShellService shellService)
        {
            ...
            this.GoToRegistrationCommand = new Command(async () => await base.GoModalTo<RegistrationPage>(null));
            this.LoginCommand = new Command( () => _shellService.SwitchContainer<TabbedShell>());
        }
    }
}